...
impl ClientConfig {
    ...
    pub fn run_scripts(&self) -> Result<u32, IoError> {
        ...
        for entry in self.script_dir.read_dir()? {
            ...
            if let Err(err) = child {
                eprintln!("Couldn't execute script at '{}': {}", path.to_str().unwrap(), err.to_string());
                break;
            };
        ...
        // todo: wait for all children to be finished
    ...
    fn default_concurrent_run() -> bool {
        false
    }
}